class WorldObjectHint extends Hint {
    constructor(
        ...
        for (let i = 0; i < hint.length; i++) {
            ...
            let h =
                ctx.measureText(hint[i].text).actualBoundingBoxAscent +
    ...
    draw() {
        ...
        for (let i = 0; i < this.descriptions.length; i++) {
            if (this.descriptionArr[i].centered) {
                ...
                ctx.fillText(
                    ...
                    this.tile.position.x + this.tile.size.x / 2 + 2,
                ...
                ctx.fillText(
                    ...
                    this.tile.position.x -
                        ...
                        this.tile.size.x / 2 +
                        2,
                    // this.tile.position.y + this.tile.size.y / 2
                    this.tile.position.y -
                        h +
                        i * first.height +
                        first.height*2 +
        ...
        for (let i = 0; i < this.descriptions.length; i++) {
            if (this.descriptionArr[i].centered) {
                ...
                ctx.fillText(
                    this.descriptions[i].text,
                    this.tile.position.x + this.tile.size.x / 2,
                    this.tile.position.y -
                        h +
                        i * first.height +
                        first.height*2 +
