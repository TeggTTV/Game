...
class Minimap {
    ...
    draw() {
        ...
        this.minimapCtx.translate(this.camera.position.x, this.camera.position.y);
        this.minimapCtx.drawImage(canvas, this.camera.position.x, this.camera.position.y, this.minimap.width, this.minimap.height, 0, 0, width, height);
        entities.forEach((entity) => {
            this.minimapCtx.fillStyle = "red";
            this.minimapCtx.fillRect(entity.position.x, entity.position.y, entity.size.x, entity.size.y);
        });
